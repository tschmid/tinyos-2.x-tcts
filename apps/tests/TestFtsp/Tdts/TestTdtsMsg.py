...
# This class implements a Python interface to the 'TestTdtsMsg'
# message type.
#
...
class TestTdtsMsg(tinyos.message.Message.Message):
    # Create a new TestTdtsMsg of size 21.
